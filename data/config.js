...
window.SURVEY_CONFIG = {
  ...
  // ── 班級清單（去重統計班級數用）──
  // ⚠️ 以下為占位範例，待換成石門國小實際班級（共 32 普通班）。
  classGroups: [
    { grade: "一年級", classes: ["甲", "乙", "丙", "丁", "戊"] },
    { grade: "二年級", classes: ["甲", "乙", "丙", "丁", "戊"] },
    { grade: "三年級", classes: ["甲", "乙", "丙", "丁", "戊"] },
    { grade: "四年級", classes: ["甲", "乙", "丙", "丁", "戊"] },
    { grade: "五年級", classes: ["甲", "乙", "丙", "丁", "戊"] },
    { grade: "六年級", classes: ["甲", "乙", "丙", "丁", "戊", "己", "庚"] }
  ],
